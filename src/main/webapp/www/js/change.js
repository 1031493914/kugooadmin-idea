$(function(){
	var objhei=$('.bottom-button').outerHeight(true);
     ...
     var windowhei =$(window).height()-50;//可是区域高度
     
     $(document).scroll(function(){

         var docscrol =$(document).scrollTop();//滚上去的高度

//         var d=(objdoc-windowhei);
//         console.log("这是元素到文档高度"+objdoc);
      /*   console.log("这是可视区域高度"+windowhei);*/
      //   console.log('这是元素到可可视区域距离'+d);
        ...
        if((objdoc-docscrol+objhei)<=(windowhei)){
         ...
         $('.bottom-button').css({'position':'fixed','bottom':'4%','width':'96%'});
