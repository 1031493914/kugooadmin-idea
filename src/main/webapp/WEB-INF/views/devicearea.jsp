...
<div class="htm-msg">
    ...
    <div class="htm-table" >
        <table class="table text-center table-bordered table-striped" id="htmtable">
            ...
            <c:forEach items="${listDeviceSellerAddressList}" var="listDeviceSellerAddressList">
                <tr>
                    <td>
                            ${listDeviceSellerAddressList.id}
                    </td>

                    <td>
                            ${listDeviceSellerAddressList.num}
                    </td>
                    <td>
                        <c:if test="${listDeviceSellerAddressList.country==''}">
                            无法定位
                        </c:if>
                        <c:if test="${listDeviceSellerAddressList.country!=''}">
                            ${listDeviceSellerAddressList.country}
                        </c:if>
